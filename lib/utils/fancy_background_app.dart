...
class AnimatedBackground extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final tween = MultiTween<_BgProps>()..add(_BgProps.color1, Color(0xffD35312).tweenTo(Colors.blue.shade600))..add(_BgProps.color2, Color(0xffA23279).tweenTo(Colors.yellow.shade600));
