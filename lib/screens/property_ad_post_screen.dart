...
class PropertyAdPostScreen extends StatefulWidget {

  final CategoryModel parent, child;
  PropertyAdPostScreen({this.parent, this.child});

  @override
  _PropertyAdPostScreenState createState() => _PropertyAdPostScreenState();
}

class _PropertyAdPostScreenState extends State<PropertyAdPostScreen> {
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButton<String>(
            ...
            isExpanded: true,
            value: listedT,
            hint: Text("Select Listed By"),
            items:
            listedBy.map((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Text(value),
                key: Key(value),
        ...
        Container(
          ...
          child: DropdownButton<String>(
            ...
            isExpanded: true,
            value: furnishT,
            hint: Text("Select Furnish Status"),
            items:
            furnishList.map((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Text(value),
                key: Key(value),
