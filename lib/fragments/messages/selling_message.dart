...
class SellingMessagesFragment extends StatefulWidget {
  @override
  _SellingMessagesFragmentState createState() => _SellingMessagesFragmentState();
}

class _SellingMessagesFragmentState extends State<SellingMessagesFragment> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child:  StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection("Users").doc(user.uid).collection("ChatList").orderBy("timestamp", descending: true).where("posting", isEqualTo: user.uid).snapshots(),
